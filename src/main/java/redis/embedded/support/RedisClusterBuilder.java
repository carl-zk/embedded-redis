...
//        final List<Server> sentinels = buildSentinels();
//        final List<Server> servers = buildServers();
...
//    }
//
//    private void buildSlaves(List<Server> servers, ReplicationGroup g) {
...
//    }
//
//    private Server buildMaster(ReplicationGroup g) {
//        serverBuilder.reset();
//        return serverBuilder.port(g.masterPort).build();
//    }
//
//    private List<Server> buildSentinels() {
//        int toBuild = this.sentinelCount;
//        final List<Server> sentinels = new LinkedList<Server>();
//        while (toBuild-- > 0) {
