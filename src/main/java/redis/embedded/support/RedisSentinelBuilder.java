...
//    private ServerProvider singleServerProvider = ServerProvider.defaultTempProvider();
...
//
//    public RedisSentinelBuilder redisExecProvider(ServerProvider singleServerProvider) {
//        this.singleServerProvider = singleServerProvider;
//        return this;
//    }
//
...
//            throw new RedisBuildingException("Server configuration is already partially build using setting(String) method!");
//        }
...
//            throw new RedisBuildingException("Server configuration is already set using redis conf file!");
//        }
//
//        if (redisConfigBuilder == null) {
